...
namespace WebsiteBanHang.Migrations
{
    ...
    [Migration("20190511104527_updateward")]
    partial class updateward
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebsiteBanHang.Models.Districts", b =>
                {
            ...
            modelBuilder.Entity("WebsiteBanHang.Models.Provinces", b =>
                {
                    b.Property<int>("ProvinceId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebsiteBanHang.Models.Address", b =>
                {
                    ...
                    b.HasOne("WebsiteBanHang.Models.Wards", "Wards")
                        .WithMany("Address")
            ...
            modelBuilder.Entity("WebsiteBanHang.Models.Districts", b =>
                {
                    b.HasOne("WebsiteBanHang.Models.Provinces", "Provinces")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("WebsiteBanHang.Models.Wards", b =>
                {
                    b.HasOne("WebsiteBanHang.Models.Districts", "Districts")
                        .WithMany("Wards")
